...
from pipelines.precipitation_model.impa.src.models.mamba.lightning import Vmamba_lightning
...
def main(args_dict, parameters_dict):
    ...
    if (
        ...
        model = Vmamba_lightning(**parameters_dict_copy)
        ...
        model = Vmamba_lightning.load_from_checkpoint(
