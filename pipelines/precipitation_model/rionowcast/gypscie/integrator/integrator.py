...
"""
rodar local:
python integrator.py --sources ['AlertaRioRG', 'InmetWS'] --period ["2024-02-02", "2024-02-03"]
"""
import argparse, os
import pandas as pd
...
from utils.date_time import is_valid_date, today, split_date, parse_to_date
...
class AlertaRioRG(Instrument):
    ...
    def _aggregate_data(self):
        ...
        df = (
            df.groupby(["institution", "instrument", "station", "datetime"])  # TODO: change transform to save station
            .agg(
                {
                    "precipitation": "sum",
                    "hour_sin": "mean",
...
Source will be ignored and data integration will continue."
    ...
    def _save_data(self):
        ...
        created_at = "output"
        filepath = f"curated/data_{created_at}.csv"
